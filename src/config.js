...
projectcards: [
    ...
    { go: "📚 前往", img: "/img/3.png", title: "MDN", subtitle: "前端开发文档", text: "Mozilla 出品的权威 Web 技术文档，开发者必备。", url: "https://developer.mozilla.org", show: false },
    { go: "🎵 前往", img: "/img/4.png", title: "QQ音乐", subtitle: "听我想听的歌", text: "随时随地，想听就听。", url: "https://y.qq.com", show: false },
    { go: "🌸 前往", img: "/img/5.jpg", title: "Pixiv", subtitle: "插画创作社区", text: "来自世界各地画师的精彩作品，总有一幅击中你。", url: "https://pixiv.net", show: false },
    { go: "🍿 前往", img: "/img/6.png", title: "哔哩哔哩", subtitle: "干杯～", text: "弹幕视频网站，总有你感兴趣的内容。", url: "https://bilibili.com", show: false },
    { go: "🗺️ 前往", img: "/img/7.jpg", title: "Notion", subtitle: "笔记与效率工具", text: "把你的想法、计划、笔记都整理在一起。", url: "https://notion.so", show: false },
    { go: "✨ 前往", img: "/img/8.png", title: "Claude", subtitle: "AI 助手", text: "有什么不懂的，来问我吧。", url: "https://claude.ai", show: false },
],
